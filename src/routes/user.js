...
const { createCustomerValidate } = require('../validate/customer.validate');
...
userRoute.get('/', requireLogin, checkPermissions(enums.UserRole.ADMIN), userController.getAllUsers);
